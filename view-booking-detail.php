...
<html lang="en">
<head>
<title>Eventsoft|| ver servicios</title>
	...
	<div class="banner jarallax">
		...
		<?php include_once('includes/header.php');?>
			<div class="wthree-heading">
				<h2>visual de todos los servicios</h2>
			</div>
		</div>
	</div>
	<!-- //banner -->
	...
	<div class="about-top">
		<div class="container">
			<div class="wthree-services-bottom-grids">
				...
				<p class="wow fadeInUp animated" data-wow-delay=".5s">detalles de su reserva.</p>
...
{               ?>
  ...
  <tr>
     ...
     <th>estado final de el servicio</th>
