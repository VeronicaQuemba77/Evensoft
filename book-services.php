...
$query->bindParam(':message',$message,PDO::PARAM_STR);
 ...
 $query->execute();
   ...
   if ($LastInsertId>0) {
    echo '<script>alert("Su solicitud de reserva ha sido enviada. Nos pondremos en contacto con usted muy pronto")</script>';
...
<html lang="en">
<head>
<title>Eventsoft | Nuestros servicios</title>
					...
					<div class="agileinfo-contact-form-grid">
						<form method="post">
							 <div class="form-group row">
                                    <label class="col-form-label col-md-4">Reserva de:</label>
                                    <div class="col-md-10">
                                        <input type="date" class="form-control" style="font-size: 20px" required="true" name="bookingfrom">
                                    </div>
                                </div>
                                               <div class="form-group row">
                                    <label class="col-form-label col-md-4">Hasta:</label>
                                    <div class="col-md-10">
                                ...
                                <div class="form-group row">
							 	...
							 	<option value="">Elija el tipo de evento que mas le interese</option>
							 	<?php 
...
<option value="<?php echo htmlentities($row->EventType);?>"><?php echo htmlentities($row->EventType);?></option>
 <?php } ?>
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-md-4">Numero de invitados:</label>
                                    <div class="col-md-10">
                                        <input type="text" class="form-control" style="font-size: 20px" required="true" name="nop">
                                    </div>
                                </div>
                                                 <div class="form-group row">
                                    <label class="col-form-label col-md-4">Mensaje(obligatorio)</label>
                                    <div class="col-md-10">
