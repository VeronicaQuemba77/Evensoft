...
<html lang="en">
<head>
<title>Eventsoft | olvide mi contraseña</title>
                ...
                <div class="col-md-6 contact-form-right">
                    ...
                    <div class="agileinfo-contact-form-grid">
                        <form action="#" method="post" name="chngpwd" onSubmit="return valid();">
                            <input type="email" class="form-control" name="email" placeholder="Correo" required="true">
                            <input type="text" class="form-control" required="true" name="Telefono" maxlength="10" pattern="[0-9]+" placeholder="Mobile Number">
                            <input type="password"class="form-control"  name="newpassword" placeholder="Nueva contraseña" required="true"/>
                            <br>
                            <input type="password" name="confirmpassword" placeholder="Confirmar contraseña" class="form-control" required="true" />
                            <br>
                            <div class="forgot">
                                                            <a href="login.php">Ya tienes una cuenta</a>
                                                        </div>
                                                        <br>
                            <button class="btn1" name="submit">Restablecer</button>
