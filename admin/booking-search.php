...
<html lang="en" class="no-focus"> <!--<![endif]-->
    <head>
        <title>Eventsoft - Busqueda de reservas</title>
        ...
        <div id="page-container" class="sidebar-o sidebar-inverse side-scroll page-header-fixed main-content-narrow">
          ...
          <?php include_once('includes/header.php');?>
            ...
            <main id="main-container">
                <!-- Page Content -->
                <div class="content">
                    <h2 class="content-heading">Busqueda de reservas</h2>
                    ...
                    <div class="block">
                        <div class="block-header block-header-default">
                            <h3 class="block-title">Buscar reserva</h3>
                        </div>
                        <div class="block-content block-content-full">
                            <!-- DataTables init on table by adding .js-dataTable-full-pagination class, functionality initialized in js/pages/be_tables_datatables.js -->
                            <form id="basic-form" method="post">
                                <div class="form-group">
                                    <label>Buscar por Numero de reserva/Nombre/telefono</label>
                            ...
                            <table class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Reserva ID</th>
                                        <th class="d-none d-sm-table-cell">Nombre del cliente</th>
