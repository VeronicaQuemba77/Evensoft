...
<!doctype html>
 <html lang="en" class="no-focus"> <!--<![endif]-->
    <head>
 <title>Eventsoft - Añadir servicios</title>
          ...
          <?php include_once('includes/header.php');?>
            ...
            <main id="main-container">
                ...
                <div class="content">
                    ...
                    <!-- Register Forms -->
                    <h2 class="content-heading">Añadir servicios</h2>
                    <div class="row">
                        <div class="col-md-12">
                            <!-- Bootstrap Register -->
                            <div class="block block-themed">
                                <div class="block-header bg-gd-emerald">
                                    <h3 class="block-title">Añadir servicio</h3>
                                ...
                                <div class="block-content">
                                    ...
                                    <form method="post">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-12" for="register1-email">Nombre de servicio:</label>
                                            <div class="col-12">
                                                 <input type="text" class="form-control" name="sername" value="" required='true'>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-12" for="register1-email">Descripcion de servicio:</label>
                                            <div class="col-12">
                                                 <textarea type="text" class="form-control" name="serdes" value="" required='true'></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-12" for="register1-password">Precio:</label>
                                            <div class="col-12">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-12">
                                                <button type="submit" class="btn btn-alt-success" name="submit">
                                                    <i class="fa fa-plus mr-5"></i> Añadir
                                                </button>
                                            </div>
                                        </div>
                                    </form>
