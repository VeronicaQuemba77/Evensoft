...
<html lang="en" class="no-focus"> <!--<![endif]-->
    <head>
        <title>eventsoft - Visualizar reporte</title>
        ...
        <div id="page-container" class="sidebar-o sidebar-inverse side-scroll page-header-fixed main-content-narrow">
          ...
          <?php include_once('includes/header.php');?>
            ...
            <main id="main-container">
                <!-- Page Content -->
                <div class="content">
                    <h2 class="content-heading">Reporte de reservas</h2>
                    ...
                    <div class="block">
                        <div class="block-header block-header-default">
                            <h3 class="block-title">reporte de reservas</h3>
                        </div>
...
?>
<h5 align="center" style="color:blue">Informe del <?php echo $fdate?> Hasta el<?php echo $tdate?></h5>
                            <table class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
                                <thead>
                                    <tr>
                                        <th class="text-center"></th>
                                        <th>reserva ID</th>
                                        <th class="d-none d-sm-table-cell">Nombre cliente</th>
                                        <th class="d-none d-sm-table-cell">telefono</th>
                                        <th class="d-none d-sm-table-cell">Correo</th>
                                        <th class="d-none d-sm-table-cell">Fecha de la reserva</th>
