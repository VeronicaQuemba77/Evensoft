<!doctype html>
 ...
 <head>
 <title>Eventsoft- Administrador</title>
...
?>
                                    ...
                                    <p class="font-w600 text-white">Total de consultas no leídas</p>
                                </div>
                            </a>
                        </div>
                        <div class="col-6 col-md-4 col-xl-3">
...
?>
                                    ...
                                    <p class="font-w600 text-white">Consultas de lectura Total</p>
                                </div>
                            </a>
                        </div>
                        <div class="col-6 col-md-4 col-xl-3">
...
?>
                                    ...
                                    <p class="font-w600 text-white">Total nueva reserva</p>
                                </div>
                            </a>
                        </div>
                        <div class="col-6 col-md-4 col-xl-3">
...
?> 
                                    ...
                                    <p class="font-w600 text-white">Total reserva aprobada</p>
                                </div>
                            </a>
                        </div>
...
?>
                                    ...
                                    <p class="font-w600 text-white">Total de reservas canceladas</p>
                                </div>
                            </a>
                        </div>
                        <div class="col-6 col-md-4 col-xl-4">
...
?>
                                    ...
                                    <p class="font-w600 text-white">Total de servicios</p>
                                </div>
                            </a>
                        </div>
                        <div class="col-6 col-md-4 col-xl-4">
...
?>
                                    ...
                                    <p class="font-w600 text-white">Total tipo de eventos </p>
                                </div>
                            </a>
                        </div>
