...
<html lang="en" class="no-focus"> <!--<![endif]-->
    <head>       
        <title>Eventsoft - Pagina de logueo</title>
    ...
    <body>
        ...
        <div id="page-container" class="main-content-boxed">
            ...
            <main id="main-container">
                            ...
                            <div class="content content-full">
                                ...
                                <div class="px-30 py-10">
                                    <a class="link-effect font-w700" href="login.php">
                                        ...
                                        <span class="font-size-xl">Eventsoft</span>
                                    </a>
                                    <h1 class="h3 font-w700 mt-30 mb-10">Bienvenido administrador</h1>
                                    <h2 class="h5 font-w400 text-muted mb-0">Por favor registrese</h2>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-12">
                                            <div class="form-material floating">
                                                ...
                                                <label for="login-username">Nombre de ususario</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                ...
                <label for="keep_me_logged_in">Mantener registrado</label>
            </div>
                                    </div>
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-sm btn-hero btn-alt-primary" name="login">
                                            <i class="si si-login mr-10"></i> inisiar sesíon
                                        </button>
                                        <div class="mt-30">
                                            
                                            <a class="link-effect text-muted mr-10 mb-5 d-inline-block" href="forgot-password.php">
                                                <i class="fa fa-warning mr-5"></i> He olvidado mi contraseña
                                            </a>
                                            <a href="../index.php">Devuelta a pagina principal!!</a>
                                        </div>
                                    </div>
                                </form>
                                <!-- END Sign In Form -->
