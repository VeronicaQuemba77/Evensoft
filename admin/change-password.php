                            ...
                            <div class="block block-themed">
                                ...
                                <div class="block-content">
                                    <form method="post" onsubmit="return checkpass();" name="changepassword">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-12" for="register1-email">Nueva contraseña:</label>
                                            <div class="col-12">
                                                 <input type="password" class="form-control" name="newpassword"  class="form-control" required="true">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-12" for="register1-password">Confirmar contraseña:</label>
                                            <div class="col-12">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-12">
                                                <button type="submit" class="btn btn-alt-success" name="submit">
                                                    <i class="fa fa-plus mr-5"></i> Cambiar
                                                </button>
                                            </div>
                                        </div>
                                    </form>
