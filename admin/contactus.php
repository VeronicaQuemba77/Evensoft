...
<!doctype html>
 <html lang="en" class="no-focus"> <!--<![endif]-->
    <head>
 <title>Eventsoft - Actualizar contactanos</title>
          ...
          <?php include_once('includes/header.php');?>
            ...
            <main id="main-container">
                ...
                <div class="content">
                    ...
                    <!-- Register Forms -->
                    <h2 class="content-heading">Actualizar contactanos</h2>
                    <div class="row">
                        <div class="col-md-12">
                            <!-- Bootstrap Register -->
                            <div class="block block-themed">
                                <div class="block-header bg-gd-emerald">
                                    <h3 class="block-title">Actualizar contactanos</h3>
...
{               ?>        
                                        ...
                                        <div class="form-group row">
                                            <label class="col-12" for="register1-email">Descripcion de la pagina:</label>
                                            <div class="col-12">
