...
<html lang="en" class="no-focus"> <!--<![endif]-->
    <head>       
        <title>Eventsoft - cambiar contraseña</title>
                        ...
                        <div class="hero-static col-md-6 col-xl-4 d-flex align-items-center bg-white invisible" data-toggle="appear" data-class="animated fadeInRight">
                            <div class="content content-full">
                                ...
                                <div class="px-30 py-10">
                                    ...
                                    <h1 class="h3 font-w700 mt-30 mb-10">No te preocupes nosotros te respaldamos</h1>
                                    <h2 class="h5 font-w400 text-muted mb-0">Por favor ingresa los siguientes detalles</h2>
                                </div>
                                ...
                                <form class="js-validation-signin px-30" method="post" name="chngpwd" onSubmit="return valid();">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-12">
                                            <div class="form-material floating">
                                                ...
                                                <label for="login-password">Telefono</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-12">
                                            <div class="form-material floating">
                                                ...
                                                <label for="login-password">Confirma la contraseña</label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-sm btn-hero btn-alt-primary" name="submit">
                                            <i class="si si-login mr-10"></i> Restablecer
                                        </button>
                                        <div class="mt-30">
